        ...
        <div className="relative container">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 font-light leading-relaxed max-w-4xl mx-auto">
              Technical expertise, certifications, and capabilities that set us apart.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 font-light leading-relaxed">
              Detailed capabilities documentation is under development. 
              For immediate capability inquiries, please contact us directly.
            </p>
          </div>
        </div>
      </section>
